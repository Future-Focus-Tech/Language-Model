...
def get_all_word_trigrams(corpus_file):
    ...
    return trigrams_as_bigrams


def generate_word_trigram_probability(corpus_file):
    trigrams_as_bigrams = get_all_word_trigrams(corpus_file)
